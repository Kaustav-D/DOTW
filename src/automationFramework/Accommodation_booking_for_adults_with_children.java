	...
	logger.info("Searching Customer");
		 ...
		 try {
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(Operations.company));
			 ...
			 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_for_adults_with_children/Customer-list-book-hotel.jpg");
		 ...
		 try{
			 ...
			 driverqa.findElement(NewAccoBooking.destCity).sendKeys(excel.getData(1, 7, 0));
			 Thread.sleep(2000);
			 action.sendKeys(Keys.ARROW_DOWN).build().perform();
			 action.sendKeys(Keys.ENTER).build().perform();
			 driverqa.findElement(NewAccoBooking.AccomUnit).sendKeys(excel.getData(1, 10, 0));
			 Thread.sleep(2000);
			 action.sendKeys(Keys.ARROW_DOWN).build().perform();
			 action.sendKeys(Keys.ENTER).build().perform();
			 driverqa.findElement(NewAccoBooking.inDate).clear();
			 driverqa.findElement(NewAccoBooking.inDate).sendKeys(excel.getData(1, 13, 0));
			 driverqa.findElement(NewAccoBooking.outDate).clear();
			 driverqa.findElement(NewAccoBooking.outDate).sendKeys(excel.getData(1, 13, 1));
			 ...
			 Thread.sleep(2000);
			 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_for_adults_with_children/Search-Hotel-filters-book-hotel.jpg");
			 ...
			 Thread.sleep(2000);
			 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_for_adults_with_children/Search-Result-book-hotel.jpg");
         ...
         try {
			driverqa.findElement(NewAccoBooking.roomtypes).click();
			 ...
			 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_for_adults_with_children/Selected-room-available-book-hotel.jpg");
			 Thread.sleep(1000);
			 ...
			 driverqa.findElement(NewAccoBooking.paxFname).sendKeys(excel.getData(1, 17, 0));
			 Thread.sleep(2000);
			 driverqa.findElement(NewAccoBooking.paxLname).sendKeys(excel.getData(1, 17, 1));
			 ...
			 Thread.sleep(3000);
			 obj.Takesnap(driverqa, "D:/Test Repository/Test Screenshots/Accommodation_booking_for_adults_with_children/Passenger-Details-book-hotel.jpg");
			 driverqa.findElement(NewAccoBooking.bookBtn).click();
			 logger.info("Entered Passenger details");
			 Thread.sleep(4000);
			 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_for_adults_with_children/Confirm-Booking-book-hotel.jpg");
			 ...
			 driverqa.findElement(PaymentPage.ccNum).sendKeys(excel.getData(1, 21, 0));
			 driverqa.findElement(PaymentPage.cvv).sendKeys(excel.getData(1, 21, 1));
			 driverqa.findElement(PaymentPage.ccName).sendKeys(excel.getData(1, 21, 2));
			 Select expirydate = new Select(driverqa.findElement(PaymentPage.expYear));
			 expirydate.selectByIndex(2);
			 driverqa.findElement(PaymentPage.zip).sendKeys(excel.getData(1, 17, 2));
			 driverqa.findElement(PaymentPage.termsconditions).click();
			 Thread.sleep(2000);
			 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_for_adults_with_children/Card-Details-book-hotel.jpg");
			 ...
			 obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_for_adults_with_children/After-booking-book-hotel.jpg");
